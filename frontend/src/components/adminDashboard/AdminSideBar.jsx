// frontend/src/components/adminDashboard/AdminSidebar.jsx
...
const AdminSidebar = () => {
  ...
  // ✅ Lấy user role để hiển thị menu phù hợp
  ...
  // ✅ Menu items cho Manager (chỉ các tính năng được phép)
  ...
  return (
    <>
      ...
      <aside
        className={`
        fixed top-0 left-0 h-screen bg-gradient-to-b from-gray-900 via-blue-900 to-purple-900 text-white z-50
