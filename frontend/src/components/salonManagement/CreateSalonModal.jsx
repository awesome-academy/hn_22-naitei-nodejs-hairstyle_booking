...
const CreateSalonModal = ({ isOpen, onClose, onCreateSalon }) => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const result = await onCreateSalon(formData);
...
CreateSalonModal.propTypes = {
  isOpen: PropTypes.bool.isRequired,
  onClose: PropTypes.func.isRequired,
  onCreateSalon: PropTypes.func.isRequired,
};
