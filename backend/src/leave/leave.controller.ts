...
export class LeaveController {
  ...
  @Get()
  async getDayOffRequests(@CurrentUser() user: JwtPayload): Promise<DayOffResponseDto[]> {
  ...
  async approveOrRejectDayOffRequest(
    ...
    return this.leaveService.approveOrRejectDayOffRequest(user.id, user.role, dayOffId, dto);
  }
}